...
set padD    $padRing; # pad depth (edge to core)
...
place_pad -row IO_SOUTH  -location [expr $start +  3*$pitch] "pad_sd_clk_o"     ; # pin no:  4
place_pad -row IO_SOUTH  -location [expr $start +  4*$pitch] "pad_gpio1_io"     ; # pin no:  5
place_pad -row IO_SOUTH  -location [expr $start +  5*$pitch] "pad_sd_cmd_io"    ; # pin no:  6
place_pad -row IO_SOUTH  -location [expr $start +  6*$pitch] "pad_gpio2_io"     ; # pin no:  7
place_pad -row IO_SOUTH  -location [expr $start +  7*$pitch] "pad_sd_dat0_io"   ; # pin no:  8
place_pad -row IO_SOUTH  -location [expr $start +  8*$pitch] "pad_gpio3_io"     ; # pin no:  9
place_pad -row IO_SOUTH  -location [expr $start +  9*$pitch] "pad_sd_dat1_io"   ; # pin no: 10
place_pad -row IO_SOUTH  -location [expr $start + 10*$pitch] "pad_gpio4_io"     ; # pin no: 11
place_pad -row IO_SOUTH  -location [expr $start + 11*$pitch] "pad_sd_dat2_io"   ; # pin no: 12
place_pad -row IO_SOUTH  -location [expr $start + 12*$pitch] "pad_gpio5_io"     ; # pin no: 13
place_pad -row IO_SOUTH  -location [expr $start + 13*$pitch] "pad_sd_dat3_io"   ; # pin no: 14
...
place_pad -row IO_EAST  -location [expr $start +  2*$pitch] "pad_gpio6_io"     ; # pin no:  3
place_pad -row IO_EAST  -location [expr $start +  3*$pitch] "pad_gpio7_io"     ; # pin no:  4
place_pad -row IO_EAST  -location [expr $start +  4*$pitch] "pad_gpio8_io"     ; # pin no:  5
place_pad -row IO_EAST  -location [expr $start +  5*$pitch] "pad_gpio9_io"     ; # pin no:  6
place_pad -row IO_EAST  -location [expr $start +  6*$pitch] "pad_gpio10_io"    ; # pin no:  7
place_pad -row IO_EAST  -location [expr $start +  7*$pitch] "pad_gpio11_io"    ; # pin no:  8
place_pad -row IO_EAST  -location [expr $start +  8*$pitch] "pad_gpio12_io"    ; # pin no:  9
place_pad -row IO_EAST  -location [expr $start +  9*$pitch] "pad_gpio13_io"    ; # pin no: 10
place_pad -row IO_EAST  -location [expr $start + 10*$pitch] "pad_gpio14_io"    ; # pin no: 11
place_pad -row IO_EAST  -location [expr $start + 11*$pitch] "pad_gpio15_io"    ; # pin no: 12
place_pad -row IO_EAST  -location [expr $start + 12*$pitch] "pad_gpio16_io"    ; # pin no: 13
place_pad -row IO_EAST  -location [expr $start + 13*$pitch] "pad_gpio17_io"    ; # pin no: 14
...
place_pad -row IO_NORTH  -location [expr $start -  2*$pitch] "pad_gpio18_io"       ; # pin no:  3
place_pad -row IO_NORTH  -location [expr $start -  3*$pitch] "pad_gpio19_io"       ; # pin no:  4
place_pad -row IO_NORTH  -location [expr $start -  4*$pitch] "pad_gpio20_io"       ; # pin no:  5
place_pad -row IO_NORTH  -location [expr $start -  5*$pitch] "pad_gpio21_io"       ; # pin no:  6
place_pad -row IO_NORTH  -location [expr $start -  6*$pitch] "pad_gpio22_io"       ; # pin no:  7
place_pad -row IO_NORTH  -location [expr $start -  7*$pitch] "pad_gpio23_io"       ; # pin no:  8
place_pad -row IO_NORTH  -location [expr $start -  8*$pitch] "pad_gpio24_io"       ; # pin no:  9
place_pad -row IO_NORTH  -location [expr $start -  9*$pitch] "pad_gpio25_io"       ; # pin no: 10
place_pad -row IO_NORTH  -location [expr $start - 10*$pitch] "pad_gpio26_io"       ; # pin no: 11
place_pad -row IO_NORTH  -location [expr $start - 11*$pitch] "pad_gpio27_io"       ; # pin no: 12
place_pad -row IO_NORTH  -location [expr $start - 12*$pitch] "pad_gpio28_io"       ; # pin no: 13
place_pad -row IO_NORTH  -location [expr $start - 13*$pitch] "pad_gpio29_io"       ; # pin no: 14
