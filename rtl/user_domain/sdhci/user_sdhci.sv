...
module user_sdhci #(
  ...
  logic sd_rst_n, cmd_rst_n, dat_rst_n;
  ...
  assign cmd_rst_n = rst_ni && !reg2hw.software_reset.software_reset_for_cmd_line.q;  //comand circuit soft reset
  assign dat_rst_n = rst_ni && !reg2hw.software_reset.software_reset_for_dat_line.q;  //dat circuit soft reset
