...
package safety_soc_ctrl_reg_pkg;
  ...
  // Register -> HW type
  typedef struct packed {
    safety_soc_ctrl_reg2hw_bootaddr_reg_t bootaddr; // [65:34]
    safety_soc_ctrl_reg2hw_fetchen_reg_t fetchen; // [33:33]
    safety_soc_ctrl_reg2hw_corestatus_reg_t corestatus; // [32:1]
    safety_soc_ctrl_reg2hw_bootmode_reg_t bootmode; // [0:0]
  } safety_soc_ctrl_reg2hw_t;

  // HW -> register type
  typedef struct packed {
    safety_soc_ctrl_hw2reg_fetchen_reg_t fetchen; // [3:2]
    safety_soc_ctrl_hw2reg_bootmode_reg_t bootmode; // [1:0]
