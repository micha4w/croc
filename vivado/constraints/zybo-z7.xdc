...
# Pmod Header JD
# --------------------------------------------------------------------------------------------------
set_property -dict { PACKAGE_PIN T14  IOSTANDARD LVCMOS33 }     [get_ports { sd_dat3_io }];          #IO_L5P_T0_34               Sch=jd_p[1]
set_property -dict { PACKAGE_PIN T15  IOSTANDARD LVCMOS33 }     [get_ports { sd_cmd_io  }];          #IO_L5N_T0_34               Sch=jd_n[1]
set_property -dict { PACKAGE_PIN P14  IOSTANDARD LVCMOS33 }     [get_ports { sd_dat0_io }];          #IO_L6P_T0_34               Sch=jd_p[2]
set_property -dict { PACKAGE_PIN R14  IOSTANDARD LVCMOS33 }     [get_ports { sd_clk_o   }];          #IO_L6N_T0_VREF_34          Sch=jd_n[2]
set_property -dict { PACKAGE_PIN U14  IOSTANDARD LVCMOS33 }     [get_ports { sd_dat1_io }];          #IO_L11P_T1_SRCC_34         Sch=jd_p[3]
set_property -dict { PACKAGE_PIN U15  IOSTANDARD LVCMOS33 }     [get_ports { sd_dat2_io }];          #IO_L11N_T1_SRCC_34         Sch=jd_n[3]
...
# --------------------------------------------------------------------------------------------------
#set_property -dict { PACKAGE_PIN V12  IOSTANDARD LVCMOS33 }     [get_ports { start_tx_o  }];          #IO_L4P_T0_34               Sch=je[1]
...
# SD card ouputs (CARD -> FPAGA) guarantee 5ns setup/hold times around SD_CLK
#setup
